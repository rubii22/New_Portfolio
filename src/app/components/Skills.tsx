...
const Section = ({
  ...
  <div className="mb-20">
    <h3 className="text-3xl font-semibold text-cyan-400 mb-8 border-b border-cyan-500 inline-block pb-1">
      {title}
    </h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
      {skills.map((skill, idx) => (
        <div
          key={idx}
          className="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md p-5 flex flex-col items-center transition duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/20"
        >
...
export default function Skills() {
  return (
    <section
      id="skills"
      className="min-h-screen bg-gradient-to-b from-[#0b172c] to-[#0d1f39] text-white px-6 md:px-20 py-24"
    >
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-5xl font-bold text-cyan-400 mb-6">
          Skills & Expertise
        </h2>
        <p className="text-center text-gray-400 text-base max-w-2xl mx-auto mb-16">
